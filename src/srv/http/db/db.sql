...
CREATE TABLE IF NOT EXISTS AQchannel(
    ...
    chType INT,
    chDevice INT,
    FOREIGN KEY (chType) REFERENCES chanType(rowid) ON DELETE SET NULL ON UPDATE SET NULL,
    FOREIGN KEY (chDevice) REFERENCES hostDevice(rowid) ON DELETE CASCADE ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS AQreaction(
    ...
    monChan INT,
    reactGrp INT,
    FOREIGN KEY (rctFunct) REFERENCES AQfunction(rowid) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (monChan) REFERENCES AQchannel(rowid) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS AQCPS(
    ...
    CPSprof INT,
    CPSsrc INT,
    FOREIGN KEY (CPSchan) REFERENCES AQchannel(rowid) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS AQlog(
    ...
    FOREIGN KEY (assocDev) REFERENCES hostDevice(rowid) ON DELETE CASCADE ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS buttonChan(
    ...
    FOREIGN KEY (outChan) REFERENCES AQchannel(rowid) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (AQfunction) REFERENCES AQfunction(rowid) ON DELETE CASCADE ON UPDATE CASCADE);
